...
class ContactForm(forms.Form):
    ...
    tlf = forms.CharField(label="No. teléfono", min_length=12, max_length=12, required=False,
                           widget=forms.TextInput(attrs={'placeholder':'Escribe tu número de teléfono', 'class': 'form-control'}))
